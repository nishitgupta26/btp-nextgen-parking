            ...
            <div className="m-3">
              <div class="mt-4 flex flex-col justify-between items-left">
                ...
                <div className="flex flex-row items-center mt-3">
                  <img src={locIcon} alt="Location Icon" className="w-6 h-6 mr-4"/>
              ...
              <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-4">
                <p class="inline-flex flex-col text-gray-800">
                  ...
                  <span class="text-sm text-slate-600 mt-2 xl:mt-0">
                    {lot.type}
                  </span>
                </p>
                {/* <p class="inline-flex flex-col text-gray-800">
                ...
                <div class="flex items-center ">
                  ...
                  >
                    <svg
                      ...
                      aria-hidden="true"
                      class="icon icon-tabler icons-tabler-outline icon-tabler-car-garage w-3.5 h-3.5 me-2"
                    >
